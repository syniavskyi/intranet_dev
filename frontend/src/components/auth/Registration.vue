<template>
    <div class="plane-parent plane-parent-registration">
        <!-- dialog -->
        <transition name="slide-backdrop" v-if="openDialog">
            <div class="backdrop" v-if="openDialog"></div>
        </transition>
        <transition name="slide" v-if="openDialog">
            <div class="modal" v-if="openDialog">
