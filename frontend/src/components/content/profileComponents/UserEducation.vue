<template>
     ...
     <div class="profile-tile">
                    ...
                    <div >
                        <div v-for="(education, index) in userEducation" :key='index'>
                            ...
                            <input :disabled="!editMode" v-model="education.FieldOfStudy"/>
                            <input :disabled="!editMode" v-model="education.University"/>
                            <input :disabled="!editMode" v-model="education.StudyType"/>
                            <input :disabled="!editMode" v-model="education.AcademicTitle"/>
